...
//Ten cua so
const std::string WINDOW_TITLE = "Dino running";
...
const int PLAY_BUTTON_POSY= 160;
const int HELP_BUTTON_POSX = 565;
const int HELP_BUTTON_POSY = 267;
const int EXIT_BUTTON_POSX = 565;
const int EXIT_BUTTON_POSY = 376;
